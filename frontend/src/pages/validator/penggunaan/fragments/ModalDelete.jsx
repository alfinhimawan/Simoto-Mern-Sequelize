...
import { deleteLog_penggunaan } from "./ApiHandler";
...
export default function ModalDelete({ isOpen, onClose, payload, reload }) {
  return (
    // buat modal untuk menghapus log_penggunaan
    <Modal
      size={{ base: "xs", md: "sm" }}
      isOpen={isOpen}
      onClose={onClose}
      ...
      <ModalContent borderRadius="3xl" py={8}>
        <ModalBody alignItems="center" textAlign="center">
          ...
          <Text fontFamily={"Poppins"} as="h3" fontSize={"lg"} fontWeight={600}>
            Hapus log_penggunaan Ini?
          </Text>
          <Text fontFamily={"Poppins"} as="h6" fontSize={"xs"} fontWeight={400}>
            Apakah anda yakin ingin menghapus log_penggunaan ini?
          </Text>
        </ModalBody>
        <ModalFooter justifyContent="center">
          ...
          <Button
            ...
            onClick={async () => {
              await deleteLog_penggunaan(payload);
              await reload();
              onClose();
            }}
          >
